export const blogsContent = [
    ...
    },
    {
        ...
        full_content: `<p># <strong>What?</strong><br />
        - js runtime (server environment) (not a language or a framework)<br />
        - build on the V8 JS engine (same as google)<br />
        <ul><li>V8 Engine - in a browser gets access to DOM context only (limited access) - Window and Document objects</li>
        <li>V8 Engine - in a Node.js can access Network APIs, files system, memory, I/O, ...</li></ul>
        - it allows to run JS on the server<br />
        - can generate dynamic pages content, create open read write delete &amp; close files on server, &amp; CRUD operations</p>
        ...
        <p># <strong>NVM (Node Version Manager)</strong><br />- used to manage different version of node<br />- suggested if the developer is working on multiple projects that require different node version<br />- how to install</p>
        <div class="didrde-code"><pre>
        nvm install [version-number] // to install a specific node version
        nvm install node // to install the latest version of node</pre></div>
        <p># <strong>REPL (Read-Evaluat-Print-Loop)</strong><br />
        - Nodejs has a built in REPL and to access it on command promot - type node and hit enter. then the command-promot will have a behaviour like browser console tab. NB: all the variable are created on memory, on restarting REPL they will vanish.</p>
        ...
        <p># <strong>How to execute JS file using Node?</strong><br />node [name of the js file name]</p>
        ...
        <p># <strong>How to use node?</strong><br />
        Example<br />
        - person.js file
        <div class="didrde-code"><pre>
        class Person {
        ...
        const person1 = new Person('James', 20);
        person1.greetings();
        </pre></div>
        ...
        fs.readFile(
            path.join(__dirname, '/test', 'hello.txt'),
            'utf8', // without this it will gives a raw buffer, not the actual data
            (err, data) => {
                if(err) throw err;
                console.log(data);
            });        
        ...
        myEmitter.emit('event'); // when this is called then the previous line of code emitted
        </pre></div>
        <p>Example</p>
        <p>* logger.js file</p>
        <div class="didrde-code"><pre>
    ...
    },
    {
        ...
        <pre>XmlBeanFactory factory = new XmlBeanFactory (new ClassPathResource("Beans.xml"));\nHelloWorld obj = (HelloWorld) factory.getBean("helloWorld");\nobj.getMessage();
        </pre></div></li>
        ...
        <div class="didrde-code">
        <pre>ApplicationContext context = new FileSystemXmlApplicationContext ("C:/path/to/bean/xml/file/Beans.xml");\nHelloWorld obj = (HelloWorld) context.getBean("helloWorld");\nobj.getMessage();</pre>
        </div>
        </li></ul>`,
        images: [],
